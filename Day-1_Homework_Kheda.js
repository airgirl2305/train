...
Напишите цикл, который поочерёдно выводит в консоль числа от 0 до 10,
...
Напишите функцию square, которая принимает на вход значение
...
//let  square = (data) => {return (Number.isNaN(Number(data))) ? 'Ошибка преобразования данных': data ** 2;}

function square(data) {
    if (Number.isNaN(Number(data)) || typeof val === 'object') { //  if(Number.isNaN(num) || Array.isArray(val) || typeof val === 'boolean' || typeof val === 'object')
